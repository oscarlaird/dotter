...
export class BayesianSession {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        BayesianSessionFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    lexicographic_tokens_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.bayesiansession_lexicographic_tokens_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
 ...
 */
export function debugPanicTest() {
    wasm.debugPanicTest();
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./bayesian_bg.js": import0,
    };
}

const BayesianSessionFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('bayesian_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
